...
func (openAI Client) EnginePath() string {
...
func (openAI *Client) APIHeaders() map[string]string {
...
func (openAI *Client) MakeRequest(endpoint string, body interface{}) ([]byte, error) {
	...
	// add todo context to get passed linter
...
func (openAI *Client) EditCode(input string, instruction string) (string, error) {
	// build the edit body
	var editBody = EditRequestBody{
...
func (openAI *Client) GenerateCode(input string) ([]string, error) {
	// FIXME: Have the request fill in the parameters based on some global settings.
	// build the request body
	var completionBody = CompletionRequestBody{
		Prompt:    input,
